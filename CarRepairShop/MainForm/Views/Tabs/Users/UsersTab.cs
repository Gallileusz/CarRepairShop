...
namespace CarRepairShop.MainForm.Views.Tabs.CRM
{
    public partial class UsersTab : UserControl, IUsersTabView
    {
        ...
        public void LoadUsersToGrid(List<Domain.Entities.Users> users)
        {
            ...
            dgvUsers.Columns[nameof(Domain.Entities.Users.Name)].HeaderText = Library.Texts.MainView.Users.ColumnName;
            dgvUsers.Columns[nameof(Domain.Entities.Users.Surname)].HeaderText = Library.Texts.MainView.Users.Surname;
